...
namespace Gambit
{
  namespace Nash
  {
    ...
    template <class T>
    List<List<MixedStrategyProfile<T>>>
    ...
    template <>
    bool EnumMixedStrategySolver<double>::EqZero(const double &x)
    {
    ...
    template <>
    bool EnumMixedStrategySolver<Rational>::EqZero(const Rational &x)
    {
      return (x == Rational(0));
    }
